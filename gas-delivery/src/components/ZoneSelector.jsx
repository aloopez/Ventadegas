...
export default function ZoneSelector() {
    ...
    navigator.geolocation.getCurrentPosition(
      async (pos) => {
        ...
        try {
          ...
          // SOLUCIÓN: Usar "prev" asegura que no borremos lo que el usuario escribió mientras cargaba el GPS
  ...
  const isLoading = gpsEstado.tipo === 'loading';
  ...
  return (
    <div className="section">
      ...
      <div className="gps-box" style={{ marginTop: '14px' }}>
        <button className="btn-gps" onClick={usarGPS} disabled={isLoading}>
            {isLoading ? 'Localizando...' : 'Usar mi ubicación actual'}
        </button>
        ...
        {mapaUrl && (
          <div className="map-container">
            ...
            <p className="map-help" style={{ fontSize: '13px', color: 'var(--text-muted)', marginTop: '8px' }}>
              ¿Es correcta la ubicación? Puedes ajustar la dirección arriba si es necesario.
            </p>
          </div>
        )}
      </div>
